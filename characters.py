...
class Goku(Hero):
    def __init__(self):
        super().__init__("Goku", 100, 25, 200, 25, 30)

class Vegeta(Hero):
    def __init__(self):
        super().__init__("Vegeta", 100, 25, 150, 25, 30)
...
class Raditz(Enemy):
    def __init__(self, level):
        super().__init__("Raditz", 80, 10, level)

class Cell(Enemy):
    def __init__(self, level):
        super().__init__("Cell", 90, 20, level)

class Freezer(Enemy):
    def __init__(self, level):
        super().__init__("Freezer", 100, 25, level)

class Androide16(Enemy):
    def __init__(self, level):
        super().__init__("Androide16", 30, 10, level)

class Androide17(Enemy):
    def __init__(self, level):
        super().__init__("Androide17", 30, 12, level)

class Androide18(Enemy):
    def __init__(self, level):
        super().__init__("Androide18", 35, 10, level)

class Burter(Enemy):
    def __init__(self, level):
        super().__init__("Burter", 20, 7, level)

class Recoome(Enemy):
    def __init__(self, level):
        super().__init__("Recoome", 20, 7, level)

class CapGinyu(Enemy):
    def __init__(self, level):
        super().__init__("CapGinyu", 20, 7, level)
